...
namespace i2TradePlus.ITSNetBusinessWS
{
	...
	public class ViewCustomer_RiskManagementCompletedEventArgs : AsyncCompletedEventArgs
	{
		...
		internal ViewCustomer_RiskManagementCompletedEventArgs(object[] results, Exception exception, bool cancelled, object userState) : base(exception, cancelled, userState)
		{
			while (false)
			{
