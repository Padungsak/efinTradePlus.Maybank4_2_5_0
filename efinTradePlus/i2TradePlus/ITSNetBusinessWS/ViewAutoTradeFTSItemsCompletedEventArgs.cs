...
namespace i2TradePlus.ITSNetBusinessWS
{
	...
	public class ViewAutoTradeFTSItemsCompletedEventArgs : AsyncCompletedEventArgs
	{
		...
		internal ViewAutoTradeFTSItemsCompletedEventArgs(object[] results, Exception exception, bool cancelled, object userState) : base(exception, cancelled, userState)
		{
			while (false)
			{
